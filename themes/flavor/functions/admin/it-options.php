...
$options = array(
	...
	array(
		...
		array(
			'name' => __( 'Number of Tweets', IT_TEXTDOMAIN ),
			'desc' => __( 'The number of latest Tweets to display in the widget.', IT_TEXTDOMAIN ),
			'id' => 'twitter_number',
			'target' => 'twitter_number',
			'type' => 'select'
		),
		array(
			'name' => __( 'Refresh Interval', IT_TEXTDOMAIN ),
			'desc' => __( 'How often to automatically refresh the latest Tweets (does not refresh the whole page).', IT_TEXTDOMAIN ),
			'id' => 'twitter_refresh',
			'target' => 'seconds_twitter',
			'nodisable' => true,
			'type' => 'select'
		),
		
		array(
			'name' => __( 'Standard Tweet Prefix', IT_TEXTDOMAIN ),
			'desc' => __( 'Example: about 2 hours ago "WE SAID", we love working on WordPress themes!', IT_TEXTDOMAIN ),
			'id' => 'twitter_text_default',
			'default' => '',
			'htmlspecialchars' => true,
			'type' => 'text'
		),
		...
		array(
			'name' => __( 'Past Tense Prefix', IT_TEXTDOMAIN ),
			'desc' => __( 'Example: about 4 hours ago "WE" ran a marathon.', IT_TEXTDOMAIN ),
			'id' => 'twitter_text_ed',
			'default' => '',
			'htmlspecialchars' => true,
			'type' => 'text'
		...
		array(
			'name' => __( 'Present Tense Prefix', IT_TEXTDOMAIN ),
			'desc' => __( 'Example: about 7 minutes ago "WE WERE" drinking a pint of Bells Consecrator Doppelbock.', IT_TEXTDOMAIN ),
			'id' => 'twitter_text_ing',
			'default' => '',
			'htmlspecialchars' => true,
			'type' => 'text'
		...
		array(
			'name' => __( 'Reply Prefix', IT_TEXTDOMAIN ),
			'desc' => __( 'Example: about 2 hours ago "WE REPLIED" @wordpress thank you for your magnanimosity.', IT_TEXTDOMAIN ),
			'id' => 'twitter_text_reply',
			'default' => '',
			'htmlspecialchars' => true,
			'type' => 'text'
		),
		...
		array(
			'name' => __( 'URL Prefix', IT_TEXTDOMAIN ),
			'desc' => __( 'Example: about 45 minutes ago "WE WERE CHECKING OUT" Dubstep meets guns: http://youtu.be/hDlif8Km4S4', IT_TEXTDOMAIN ),
			'id' => 'twitter_text_url',
			'default' => '',
			'htmlspecialchars' => true,
			'type' => 'text'
