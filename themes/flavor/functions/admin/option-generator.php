...
class itOptionGenerator {
	...
	function sociable( $value ) {
		...
		foreach( $sociable_keys as $key ) {
			...
			$hover = ( !empty( $val['hover'] ) ) ? esc_url(stripslashes( $val['hover'] ) ) : '';
	...
	function select_target_options( $type, $nodisable = false ) {
		...
		switch( $type ) {
			...
			case 'featured_transition':
				$transitions = array( 'random' => 'Random', 'boxslide' => 'Box Slide', 'boxfade' => 'Box Fade', 'slotzoom-horizontal' => 'Slot Zoom Horizontal', 'slotslide-horizontal' => 'Slot Slide Horizontal', 'slotfade-horizontal' => 'Slot Fade Horizontal', 'slotzoom-vertical' => 'Slot Zoom Vertical', 'slotslide-vertical' => 'Slot Slide Vertical', 'slotfade-vertical' => 'Slot Fade Vertical', 'curtain-1' => 'Curtain 1', 'curtain-2' => 'Curtain 2', 'curtain-3' => 'Curtain 3', 'slideleft' => 'Slide Left', 'slideright' => 'Slide Right', 'slideup' => 'Slide Up', 'slidedown' => 'Slide Down', 'fade' => 'Fade', 'slidehorizontal' => 'Slide Horizontal', 'slidevertical' => 'Slide Vertical', 'papercut' => 'Papercut', 'flyin' => 'Flyin', 'turnoff' => 'Turn Off', 'cube' => 'Cube', '3dcurtain-vertical' => '3D Curtain Vertical', '3dcurtain-horizontal' => '3dcurtain-horizontal' );
				foreach( $transitions as $key => $value ) {
					$options[$key] = $value;
				}
				break;
			case 'featured_caption_effect':
				$effects = array( 'sft' => 'Short From Top', 'sfb' => 'Short From Bottom', 'sfr' => 'Short From Right', 'sfl' => 'Short From Left', 'lft' => 'Long From Top', 'lfb' => 'Long From Bottom', 'lfr' => 'Long From Right', 'lfl' => 'Long From Left', 'fade' => 'Fade In', 'randomrotate' => 'Fade in and rotate from a random position' );
				foreach( $effects as $key => $value ) {
					$options[$key] = $value;
				}
				break;
			case 'timeperiod':
				$effects = array( 'This Week' => 'This Week', 'This Month' => 'This Month', 'This Year' => 'This Year', '-7 days' => 'Within Past Week', '-30 days' => 'Within Past Month', '-60 days' => 'Within Past 2 Months', '-90 days' => 'Within Past 3 Months', '-180 days' => 'Within Past 6 Months', '-365 days' => 'Within Past Year', 'all' => 'All Time' );
				foreach( $effects as $key => $value ) {
					$options[$key] = $value;
				}
				break;
			case 'author_role':
				$effects = array( 'all' => 'All Roles', 'subscriber' => 'Subscribers', 'contributor' => 'Contributors', 'editor' => 'Author' );
				foreach( $effects as $key => $value ) {
					$options[$key] = $value;
				}
				break;
			case 'author_order':
				$effects = array( 'nicename' => 'Nice Name', 'email' => 'Email', 'url' => 'URL', 'registered' => 'Registered', 'display_name' => 'Display Name', 'post_count' => 'Post Count' );
				foreach( $effects as $key => $value ) {
					$options[$key] = $value;
				}
				break;
