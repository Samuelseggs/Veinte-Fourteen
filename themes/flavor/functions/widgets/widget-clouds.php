...
class it_clouds extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<li><a href="#tag-cloud" class="info active icon-tag" title="' . __('Tag Cloud', IT_TEXTDOMAIN) . '"></a></li>';
		echo '<li><a href="#category-cloud" class="info icon-category" title="' . __('Category Cloud', IT_TEXTDOMAIN) . '"></a></li>';                
	...
	function form( $instance ) {
        ...
        <p>
			...
			<label for="<?php echo $this->get_field_id( 'categories' ); ?>"><?php _e( 'Display Category Clouds',IT_TEXTDOMAIN); ?></label>             
		</p>
