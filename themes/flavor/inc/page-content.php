    	...
    	<div class="sortbar">
        	...
        	<div class="row">
            	...
            	<div class="span12">
                    ...
                    <?php if(!$disable_like_count) echo it_get_likes($post->ID, false, true); ?>
                    
                    <?php if(!$disable_comment_count) echo it_get_comments($post->ID, true, true); ?>
                    
                    <?php if(!$disable_signup) it_signup_form(); ?>
                    
                    <div class="sortbar-right<?php if($disable_date) { ?> hidden<?php } ?>">
                        
                        <div class="meta-data" itemscope itemtype="http://schema.org/Article">
                                        ...
                                        <?php if(($minisite && ($disable_review!='true' || ($thumbnail!='none' && has_post_thumbnail()))) || ($thumbnail!='none' && has_post_thumbnail())) { ?>
                                            ...
                                            <div class="featured-panel<?php if((!$minisite || $disable_review=='true') && $thumbnail!='790' && $thumbnail!='1095') { ?> floated<?php } ?>"<?php if(!empty($video) && $thumbnail!='790' && $thumbnail!='1095') { ?> style="width:<?php echo $thumbnail; ?>px;"<?php } ?>>
                                                ...
                                                if(!empty($video)) {
                                                    ...
                                                    $featured_image = it_featured_image(get_the_ID(), 'single-'.$thumbnail, 818, 450, true); 
                                                } else {
                                                    $full = ' full';
                                                }
                                                ?>
