<script type="text/javascript">
	...
	jQuery(document).ready(function() { 
		...
		$twitter_count = it_get_setting('twitter_number');
		if(empty($twitter_count)) $twitter_count=5; 
		$twitter_refresh = it_get_setting('twitter_refresh');
		if(empty($twitter_refresh)) $twitter_refresh=120;
		?>		
		jQuery(".latest-tweets").tweet({
			modpath: '<?php echo THEME_URI; ?>/functions/twitter/',
			join_text: "auto",
			username: "<?php echo it_get_setting('twitter_username'); ?>",
			avatar_size: 32,
			count: <?php echo $twitter_count; ?>,
			auto_join_text_default: "<?php echo it_get_setting('twitter_text_default'); ?>",
			auto_join_text_ed: "<?php echo it_get_setting('twitter_text_ed'); ?>",
			auto_join_text_ing: "<?php echo it_get_setting('twitter_text_ing'); ?>",
			auto_join_text_reply: "<?php echo it_get_setting('twitter_text_reply'); ?>",
			auto_join_text_url: "<?php echo it_get_setting('twitter_text_url'); ?>",
			loading_text: "loading tweets...",
			refresh_interval: <?php echo $twitter_refresh; ?>					  	
		});	
