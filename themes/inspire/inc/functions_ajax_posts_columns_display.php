								...
								if ($result_cmb_comp_excerpt == "checked") {
									...
									?>
										<div class="item-excerpt quote">
											<a href="<?php echo get_permalink($results_query[$i]->ID); ?>"><blockquote> <?php if (!empty($result_cmb_excerpt)) {echo $result_cmb_excerpt;} else {echo mb_make_excerpt($results_query[$i]->post_content, $default_excerpt_len, true);} ?> </blockquote></a>
										</div>
									<?php		
									} else {
									?>
										<div class="item-excerpt">
											<a href="<?php echo get_permalink($results_query[$i]->ID); ?>"><p><?php if (!empty($result_cmb_excerpt)) {echo $result_cmb_excerpt;} else {echo mb_make_excerpt($results_query[$i]->post_content, $default_excerpt_len, true);} ?></p></a>
										</div>
									<?php
									}
								}
