...
// Retrieve all parameters - remove code, action, content, type & form
...
/* Code for generating shortcodes based on user input from text editor modal */
...
if (isset($_POST['code'])) {
	...
	} else if ($codeName == 'br' || $codeName == 'hr' || $codeName == 'clear' || $codeName == 'check' || $codeName == 'cross'){
