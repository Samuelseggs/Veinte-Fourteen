...
function jsIncludes() {
	...
	wp_register_script('likesScript', get_template_directory_uri() . '/includes/like-this/likesScript.js', 'jquery', '1.0');
...
global $wpdb;
 ...
 <?php endif; 
	...
	function form( $instance ) {
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','elemis'); ?></label> 
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
		</p>
		
		
		<p>
		<label for="<?php echo $this->get_field_id('numberOfPostsToShow'); ?>"><?php _e('Number of Posts to Show:','elemis'); ?></label> 
