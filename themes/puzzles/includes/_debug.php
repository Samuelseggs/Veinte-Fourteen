...
if (!function_exists('ds')) { function ds(&$var) { 	dumpScreen($var); } }
if (!function_exists('df')) { function df(&$var) { 	dumpFile($var); } }
if (!function_exists('dm')) { function dm($var) {	dieMsg($var); } }
if (!function_exists('tm')) { function tm($var) {	traceMsg($var); } }
