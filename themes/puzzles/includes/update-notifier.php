...
define( 'NOTIFIER_THEME_NAME', 'Puzzles' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'puzzles' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_puzzles.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
?>
	...
	<div class="wrap">
		...
		<div><img style="margin: 0 0 20px 0; border: 1px solid #ddd;" src="<?php echo get_bloginfo( 'template_url' ) . '/screenshot.png'; ?>" /></div>
		
		<div id="theme_update_instructions">
		    <h3><?php _e('Update Download and Instructions', 'themerex'); ?></h3>
		    <p><?php echo sprintf(__('<strong>Please note:</strong> make a <strong>backup</strong> of the Theme inside your WordPress installation folder <strong>/wp-content/themes/%s/</strong>', 'themerex'), NOTIFIER_THEME_FOLDER_NAME); ?></p>
