...
class themerex_qrcode_widget extends WP_Widget {
	...
	function form($instance) {
		...
		wp_enqueue_style( 'widget-qrcode-style',  get_template_directory_uri() . '/widgets/qrcode/widget-qrcode-admin.css' );
		...
		<div class="widget_qrcode">
        	<div class="qrcode_tabs">
                ...
                <div id="tab_settings" class="tab_content tab_settings">
                    ...
                    <p>
                        ...
                        <input onmousedown="initQRCode()" onfocus="initQRCode()" id="<?php echo $this->get_field_id('bg'); ?>" name="<?php echo $this->get_field_name('bg'); ?>" value="<?php echo $instance['bg']; ?>" style="width:100%; background-color:<?php echo $instance['bg']; ?>" class="iColorPicker fld_bg" />
                    </p>
                </div>
            ...
            <p>
                <input class="fld_button_draw" id="<?php echo $this->get_field_id('button_draw'); ?>" name="<?php echo $this->get_field_name('button_draw'); ?>" value="<?php _e('Update', 'themerex'); ?>" type="button" />
