...
<style type="text/css">
	...
	.single-page .main-content a:visited {color:<?php echo $accent; ?>;}
	...
	if(!empty($font_widgets) && $font_widgets!='spacer') {		
		echo '.widget, .widget a, .post-list .list-item a.title, .topten-articles .panel a.title {font-family:'.$font_widgets.';';
