                            ...
                            <div class="revolution-slider <?php echo $featured_layout; ?>">
                                ...
                                <ul>
                                    ...
                                    while (have_posts()) : the_post();  $postcount++;	
                                        ...
                                        if( !empty( $video ) )
                                            $video = it_video( $args = array( 'url' => $video, 'video_controls' => it_get_setting('featured_video_controls'), 'style' => it_get_setting('featured_video_style'), 'parse' => true, 'width' => $width, 'height' => $height, 'noframe' => '1' ) );												
